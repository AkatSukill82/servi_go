    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background">
      <div className="max-w-md w-full p-8 bg-card rounded-lg shadow-lg border border-border">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-4">Accès restreint</h1>
          <p className="text-muted-foreground mb-8">
            Vous n'êtes pas enregistré sur cette application. Contactez l'administrateur pour demander l'accès.
          </p>
