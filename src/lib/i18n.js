...
export const translations = {
  fr: {
    ...
    profile_iban: 'IBAN (Bankgegevens)',
    profile_save: 'Opslaan',
    profile_logout: 'Afmelden',
    profile_delete: 'Mijn account verwijderen',
    profile_saving: 'Opslaan...',
    profile_delete_confirm_title: 'Account verwijderen?',
    profile_delete_confirm_desc: 'Deze actie is onomkeerbaar. Al uw gegevens worden permanent verwijderd.',
    profile_delete_confirm_btn: 'Verwijderen',
    // BCE
  ...
  de: {
    ...
    profile_address: 'Adresse',
    profile_iban: 'IBAN (Bankdaten)',
    profile_save: 'Speichern',
    profile_logout: 'Abmelden',
    profile_delete: 'Konto löschen',
    profile_saving: 'Speichern...',
    profile_delete_confirm_title: 'Konto löschen?',
    profile_delete_confirm_desc: 'Diese Aktion ist unwiderruflich. Alle Ihre Daten werden dauerhaft gelöscht.',
