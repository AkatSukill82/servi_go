...
const ARTICLES = [
  {
    ...
    content: `La société ServiGo (ci-après « la Plateforme ») met en relation des particuliers (ci-après « Clients ») avec des prestataires de services indépendants (ci-après « Professionnels ») pour la réalisation de services à domicile (plomberie, électricité, serrurerie, déménagement, etc.). Les présentes CGU régissent l'ensemble des relations entre ServiGo, les Clients et les Professionnels. Toute utilisation de la Plateforme implique l'acceptation pleine et entière des présentes CGU.`
  },
  {
  ...
  },
  {
    ...
    content: `Lors de l'inscription, l'utilisateur fournit des informations exactes et à jour. ServiGo procède à une vérification d'identité via carte d'identité électronique belge (eID) pour les Professionnels. Les Professionnels doivent également fournir : une attestation d'assurance professionnelle en cours de validité, leur numéro BCE (Banque-Carrefour des Entreprises) valide. Tout document falsifié entraîne la résiliation immédiate du compte et peut faire l'objet de poursuites judiciaires.`
  },
  {
  ...
  {
    title: "Article 5 — Contrat de mission",
  ...
  {
    title: "Article 6 — Prix et facturation",
    content: `Les prix affichés sont indiqués en euros TTC. ServiGo perçoit une commission sur chaque mission réalisée. Les Professionnels s'acquittent d'un abonnement mensuel de 10 € HT (12,10 € TTC) prélevé automatiquement via Stripe. Les factures sont disponibles dans l'espace personnel de l'utilisateur.`
  },
  {
  ...
  },
  {
    ...
    content: `Le Client s'engage à : fournir un accès sécurisé au lieu d'intervention, être présent ou représenté lors de l'intervention, payer la prestation selon les modalités convenues. Le Professionnel s'engage à : réaliser la prestation conformément au contrat signé, détenir les assurances et agréments requis par la loi belge, respecter les règles d'hygiène, de sécurité et de déontologie professionnelle.`
  },
  {
    title: "Article 9 — Litiges",
    content: `En cas de litige entre un Client et un Professionnel, ServiGo propose une procédure de médiation interne. Si le litige ne peut être résolu à l'amiable, les parties peuvent saisir le Service de Médiation pour le Consommateur (Belgique) ou les juridictions compétentes du ressort de Bruxelles.`
  },
  {
  ...
  },
  {
    ...
    content: `Les présentes CGU sont régies par le droit belge. Tout litige relatif à leur interprétation ou exécution sera soumis aux tribunaux compétents de l'arrondissement judiciaire de Bruxelles.`
  },
  {
    title: "Article 12 — Modification des CGU",
    content: `ServiGo se réserve le droit de modifier les présentes CGU à tout moment. Les utilisateurs sont informés de toute modification substantielle par email. L'utilisation continue de la Plateforme après modification vaut acceptation des nouvelles CGU.`
  },
];
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        <div className="text-center space-y-1 pb-4 border-b border-border">
          ...
          <p className="text-sm font-semibold text-foreground">Conditions Générales d'Utilisation</p>
          <p className="text-xs text-muted-foreground">Version en vigueur au 12 avril 2026</p>
        </div>
