...
export default function ProProfile() {
  ...
  const PRO_SAFE_FIELDS = new Set([
    'first_name', 'last_name', 'phone', 'address', 'photo_url',
    'category_name', 'base_price', 'hourly_rate', 'pro_description',
    'available', 'availability_slots', 'bce_number',
  ]);

  const updateMutation = useMutation({
    mutationFn: (data) => {
      const safe = Object.fromEntries(Object.entries(data).filter(([k]) => PRO_SAFE_FIELDS.has(k)));
